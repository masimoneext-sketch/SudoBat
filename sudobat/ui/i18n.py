...
STRINGS = {
    "it": {
        ...
        "flag_crashed": "Si e' chiuso/bloccato DA SOLO (crash)?",
        ...
        "flash_usercrash_title": "Ok: lo tratto come CRASH.",
        "flash_usercrash_body": "Ho riletto i log dell'emulatore: guarda la diagnosi.",
        # aggiornamento
        "update_banner": "Nuova versione {ver} disponibile -> Impostazioni",
        "set_update": "Aggiorna SudoBat",
        "update_avail": "nuova versione {ver}! (A: aggiorna)",
        "update_current": "versione {ver} (A: controlla ora)",
        "update_q": "Scaricare e installare la versione {ver}?",
        "update_note": "Esegue l'installer ufficiale (con selftest). I tuoi dati e la chiave restano.",
        "update_running": "Aggiornamento in corso... (puo' volerci un minuto)",
        "update_done": "Aggiornato!",
        "update_restart": "Chiudi e riapri SudoBat per usare la nuova versione.",
        "update_fail": "Aggiornamento fallito:",
        "update_uptodate": "Sei gia' all'ultima versione ({ver}).",
        "update_nonet": "Controllo non riuscito (niente rete?).",
        # wizard mappatura pad
        "remap_title": "Tasti del controller",
        ...
        "remap_savefail": "Salvataggio mappatura fallito:",
        "set_remap_hint": "  (A: rimappa i tasti)",
        "footer_remap": "Premi il tasto sul pad   ESC (tastiera): annulla",
        "ans_yes": "Si'",
        "ans_no": "No",
        # esiti / escalation
    ...
    "en": {
        ...
        "flag_crashed": "Did it close/freeze ON ITS OWN (crash)?",
        ...
        "flash_usercrash_title": "Ok: treating it as a CRASH.",
        "flash_usercrash_body": "I re-read the emulator logs: check the diagnosis.",
        "update_banner": "New version {ver} available -> Settings",
        "set_update": "Update SudoBat",
        "update_avail": "new version {ver}! (A: update)",
        "update_current": "version {ver} (A: check now)",
        "update_q": "Download and install version {ver}?",
        "update_note": "Runs the official installer (with selftest). Your data and key are kept.",
        "update_running": "Updating... (may take a minute)",
        "update_done": "Updated!",
        "update_restart": "Close and reopen SudoBat to use the new version.",
        "update_fail": "Update failed:",
        "update_uptodate": "You are already on the latest version ({ver}).",
        "update_nonet": "Check failed (no network?).",
        "remap_title": "Controller buttons",
        ...
        "remap_savefail": "Saving the mapping failed:",
        "set_remap_hint": "  (A: remap buttons)",
        "footer_remap": "Press the button on the pad   ESC (keyboard): cancel",
        "ans_yes": "Yes",
        "ans_no": "No",
